...
exports.build = series(miniImage, webpImage, jsFiles, scssToCss, minifyHtml);
exports.dev = series(parallel(miniImage, webpImage, jsFiles, scssToCss, minifyHtml), watchFiles);
;
